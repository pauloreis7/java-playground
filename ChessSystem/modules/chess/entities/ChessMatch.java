...
import ChessSystem.modules.chess.entities.pieces.Bishop;
import ChessSystem.modules.chess.entities.pieces.King;
import ChessSystem.modules.chess.entities.pieces.Knight;
import ChessSystem.modules.chess.entities.pieces.Pawn;
import ChessSystem.modules.chess.entities.pieces.Queen;
...
public class ChessMatch {
  ...
  public ChessPiece performChessMove(final ChessPosition sourcePosition, final ChessPosition targetPosition) {
    ...
    final boolean isInCheck = testCheck(opponent(currentPlayer));
  ...
  private Piece makeMove(Position source, Position target) {
    ChessPiece pieceToMove = (ChessPiece) board.removePiece(source);
    ...
    if (pieceToMove instanceof King && target.getColumn() == source.getColumn() + 2) {
  ...
  private void undoMove(Position source, Position target, Piece capturedPiece) {
    ChessPiece pieceToMove = (ChessPiece) board.removePiece(target);

    pieceToMove.decreaseMoveCount();
    board.placePiece(pieceToMove, source);
